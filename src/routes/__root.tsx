  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "NurpurVasi Digitals — Premium Digital Studio by Gaurav Bharti" },
      {
        ...
        content: "NurpurVasi Digitals designs and builds world-class websites, brands and digital products for ambitious companies. Premium web design, development, SEO and digital solutions.",
      },
